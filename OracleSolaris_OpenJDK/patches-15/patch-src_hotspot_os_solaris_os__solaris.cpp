...
@@ -2134,7 +2136,7 @@ void os::pd_commit_memory_or_exit(char*
...
@@ -2163,7 +2165,7 @@ void os::pd_realign_memory(char *addr, s
...
@@ -2171,7 +2173,7 @@ void os::numa_make_local(char *addr, siz
